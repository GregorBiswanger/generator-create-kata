...
export default class extends Generator {
    answers: { kataname: string, description: string, author: string, vscodeSupport: boolean };
    ...
    writing() {
        ...
        this.fs.copyTpl(
            this.templatePath("specs/_implementation.spec.ts"),
            this.destinationPath(
                `specs/${_.kebabCase(this.answers.kataname)}.spec.ts`
            ),
            {
        ...
        this.fs.copyTpl(
            this.templatePath("src/_implementation.ts"),
            this.destinationPath(`src/${_.kebabCase(this.answers.kataname)}.ts`),
            {
                projectName: _.upperFirst(_.camelCase(this.answers.kataname))
            }
        );
